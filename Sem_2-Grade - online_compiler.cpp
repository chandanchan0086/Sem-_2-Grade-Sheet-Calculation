...
int main()
{
    ...
    switch(branch_sel)
	{
		case 1:
		{
			...
			SubList={"DSP\t\t","DSP-Lab\t","DD\t\t","DD-Lab\t","ES\t\t","ES-lab\t","ESD\t\t","ESD-Lab\t","Ele-II\t","Ele-II-Lab","Proj-2\t","Semi-2\t"};
		...
		case 2:
		{
			...
			SubList={"AVD\t\t","AVD-Lab\t","LPVD\t","LPVD-Lab","UVM\t\t","UVM-Lab\t","S-VLSI\t","S-VLSI-Lab","Ele-II\t","Ele-II-Lab","Proj-2\t","Semi-2\t"};
			for(i=0;i<SubList.size()-2;i++)
			{
			    cout << "\t\t " << SubList[i] << "\nEnter the IA marks(50) : ";
			    cin >> marks;
		...
		case 3:
		{
			...
			SubList={"ABDS\t","ABDS-Lab","MLR & LR","MLR&LR-Lab","ML-BD\t","ML-BD-Lab","HI\t\t","HI-Lab\t","Ele-II\t","Ele-II-Lab","Proj-2\t","Semi-2\t"};
			for(i=0;i<SubList.size()-2;i++)
			{
			    cout << "\t\t " << SubList[i] << "\nEnter the IA marks(50) : " ;
			    cin >> marks;
		...
		case 4:
		{
			...
			SubList={"CN\t\t","CN-Lab\t","CS\t\t","CS-Lab\t","CDM\t\t","CDM-Lab\t","BD & DV\t","BD & DV-Lab","Ele-II\t","Ele-II-Lab","Proj-2\t","Semi-2\t"};
			for(i=0;i<SubList.size()-2;i++)
			{
			    cout << "\t\t " << SubList[i] << "\nEnter the IA marks(50) : " ;
			    cin >> marks;
		...
		case 5:
		{
			...
			SubList={"MLR & LR","MLR&LR-Lab","ML-BD\t","ML-BD-Lab","BD-H\t","BD-H-Lab","MIS\t\t","MIS-Lab\t","Ele-II\t","Ele-II-Lab","Proj-2\t","Semi-2\t"};
			for(i=0;i<SubList.size()-2;i++)
			{
			    cout << "\t\t " << SubList[i] << "\nEnter the IA marks(50) : " ;
			    cin >> marks;
